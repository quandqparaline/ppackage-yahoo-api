 ...
 */
class CampaignCriterionServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'number_results' => 'int',
        'start_index' => 'int',
        'use' => '\OpenAPI\Client\Model\CampaignCriterionServiceUse'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['criterion_ids']) && (count($this->container['criterion_ids']) > 500)) {
            $invalidProperties[] = "invalid value for 'criterion_ids', number of items must be less than or equal to 500.";
        }
     ...
     * Sets campaign_ids
     *
     * @param int[]|null $campaign_ids <div lang=\"ja\">キャンペーンIDの配列です。</div> <div lang=\"en\">Campaign ID array.</div>
     *
     * @return self
     */
    public function setCampaignIds($campaign_ids)
    {
        ...
        if (!is_null($campaign_ids) && (count($campaign_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $campaign_ids when calling CampaignCriterionServiceSelector., number of items must be less than or equal to 500.');
        }
     ...
     * Sets criterion_ids
     *
     * @param int[]|null $criterion_ids <div lang=\"ja\">クライテリオンIDの配列です。<br> 指定しない場合は、キャンペーンID以下のすべてのクライテリアが含まれます。</div> <div lang=\"en\">Criterion ID array.<br> If no criterionIds, all of criterionIds under the campaign ID are returned.</div>
     *
     * @return self
     */
    public function setCriterionIds($criterion_ids)
    {
        ...
        if (!is_null($criterion_ids) && (count($criterion_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $criterion_ids when calling CampaignCriterionServiceSelector., number of items must be less than or equal to 500.');
        }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 10000)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling CampaignCriterionServiceSelector., must be smaller than or equal to 10000.');
        }
     ...
     * Gets use
     *
     * @return \OpenAPI\Client\Model\CampaignCriterionServiceUse|null
     */
     ...
     * Sets use
     *
     * @param \OpenAPI\Client\Model\CampaignCriterionServiceUse|null $use use
     *
     * @return self
     */
