...
class AdGroupServiceValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('ad_group', $data ?? [], null);
    ...
    */
    ...
    public function setAdGroup($ad_group)
    {
        ...
        if (is_null($ad_group)) {
            array_push($this->openAPINullablesSetToNull, 'ad_group');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ad_group', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param bool|null $operation_succeeded <div lang=\"ja\">処理結果を表示します。</div> <div lang=\"en\">Result of process.</div>
     *
     * @return self
     */
