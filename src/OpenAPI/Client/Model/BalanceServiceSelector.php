...
class BalanceServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets account_ids
     *
     * @param int[] $account_ids <div lang=\"ja\">アカウントIDの配列です。</div> <div lang=\"en\">Account IDs.</div>
     *
     * @return self
     */
    public function setAccountIds($account_ids)
    {
        ...
        if ((count($account_ids) > 200)) {
            throw new \InvalidArgumentException('invalid value for $account_ids when calling BalanceServiceSelector., number of items must be less than or equal to 200.');
        }
        if ((count($account_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_ids when calling BalanceServiceSelector., number of items must be greater than or equal to 1.');
        }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 200)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling BalanceServiceSelector., must be smaller than or equal to 200.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling BalanceServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling BalanceServiceSelector., must be bigger than or equal to 1.');
        }
