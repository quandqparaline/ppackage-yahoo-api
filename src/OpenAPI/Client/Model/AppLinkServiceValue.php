...
/**
 * AppLinkServiceValue Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;AppLinkServiceValueオブジェクトは、操作結果を含むアプリリンク情報を表します。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;AppLinkServiceValue object describes AppLink information including operation result.&lt;/div&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AppLinkServiceValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppLinkServiceValue';
    ...
    protected static $openAPITypes = [
        'app_link' => '\OpenAPI\Client\Model\AppLink',
    ...
    {
        $this->setIfExists('app_link', $data ?? [], null);
    ...
    */
     ...
     * Gets app_link
     *
     * @return \OpenAPI\Client\Model\AppLink|null
     */
    public function getAppLink()
    {
        return $this->container['app_link'];
    }

    /**
     * Sets app_link
     *
     * @param \OpenAPI\Client\Model\AppLink|null $app_link app_link
     *
     * @return self
     */
    public function setAppLink($app_link)
    {
        ...
        if (is_null($app_link)) {
            array_push($this->openAPINullablesSetToNull, 'app_link');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('app_link', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['app_link'] = $app_link;
