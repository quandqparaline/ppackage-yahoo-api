...
class AdGroupLabelServiceValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('ad_group_label', $data ?? [], null);
    ...
    */
    ...
    public function setAdGroupLabel($ad_group_label)
    {
        ...
        if (is_null($ad_group_label)) {
            array_push($this->openAPINullablesSetToNull, 'ad_group_label');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ad_group_label', $nullablesSetToNull);
            if ($index !== FALSE) {
