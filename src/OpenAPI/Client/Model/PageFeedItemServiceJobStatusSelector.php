 ...
 */
class PageFeedItemServiceJobStatusSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'account_id' => 'int',
        'job_ids' => 'int[]',
        'job_type' => '\OpenAPI\Client\Model\PageFeedItemServiceJobType',
        'number_results' => 'int',
        'start_index' => 'int'
    ];
    ...
    */
    ...
    public function setJobIds($job_ids)
    {
        ...
        if (!is_null($job_ids) && (count($job_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $job_ids when calling PageFeedItemServiceJobStatusSelector., number of items must be less than or equal to 1000.');
        }
     ...
     * Gets job_type
     *
     * @return \OpenAPI\Client\Model\PageFeedItemServiceJobType
     */
     ...
     * Sets job_type
     *
     * @param \OpenAPI\Client\Model\PageFeedItemServiceJobType $job_type job_type
     *
     * @return self
     */
