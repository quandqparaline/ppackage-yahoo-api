...
class AccountLinkServiceValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('account_link', $data ?? [], null);
    ...
    */
    ...
    public function setAccountLink($account_link)
    {
        ...
        if (is_null($account_link)) {
            array_push($this->openAPINullablesSetToNull, 'account_link');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('account_link', $nullablesSetToNull);
            if ($index !== FALSE) {
