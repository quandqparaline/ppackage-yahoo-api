 ...
 */
class PageFeedItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'account_id' => 'int',
        'approval_status' => '\OpenAPI\Client\Model\PageFeedItemServiceApprovalStatus',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('page_feed_item_id', $data ?? [], null);
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\PageFeedItemServiceApprovalStatus|null $approval_status approval_status
     *
     * @return self
     */
     ...
     *
     * @param string|null $page_feed_custom_label <div lang=\"ja\">ページフィードアイテムのカスタムラベル<br> 複数ある場合はカンマ区切り</div> <div lang=\"en\">Custom label of Page feed item.<br> If multiple, comma separated.</div>
     *
     * @return self
     */
     ...
     *
     * @param int|null $page_feed_item_id <div lang=\"ja\">ページフィードアイテムID</div> <div lang=\"en\">Page feed item ID</div>
     *
     * @return self
     */
    public function setPageFeedItemId($page_feed_item_id)
    {
        ...
        if (is_null($page_feed_item_id)) {
            array_push($this->openAPINullablesSetToNull, 'page_feed_item_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('page_feed_item_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets page_feed_url
     *
     * @param string|null $page_feed_url <div lang=\"ja\">ページフィードURL。</div> <div lang=\"en\">Url of page feed</div>
     *
     * @return self
     */
