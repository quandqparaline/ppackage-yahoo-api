...
/**
 * CampaignAssetServiceSelector Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;CampaignAssetServiceSelectorオブジェクトは、アセット情報を指定します。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;CampaignAssetServiceSelector describes the Asset information.&lt;/div&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CampaignAssetServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignAssetServiceSelector';
    ...
    protected static $openAPITypes = [
        ...
        'campaign_ids' => 'int[]',
        'asset_ids' => 'int[]',
        'types' => '\OpenAPI\Client\Model\CampaignAssetServiceType[]',
        'user_statuses' => '\OpenAPI\Client\Model\CampaignAssetServiceUserStatus[]',
        'number_results' => 'int',
        'start_index' => 'int'
    ];
    ...
    */
    ...
    public function setCampaignIds($campaign_ids)
    {
        ...
        if (!is_null($campaign_ids) && (count($campaign_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $campaign_ids when calling CampaignAssetServiceSelector., number of items must be less than or equal to 500.');
        }
    ...
    public function setAssetIds($asset_ids)
    {
        ...
        if (!is_null($asset_ids) && (count($asset_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $asset_ids when calling CampaignAssetServiceSelector., number of items must be less than or equal to 500.');
        }
     ...
     * Gets types
     *
     * @return \OpenAPI\Client\Model\CampaignAssetServiceType[]|null
     */
     ...
     * Sets types
     *
     * @param \OpenAPI\Client\Model\CampaignAssetServiceType[]|null $types types
     *
     * @return self
     */
    public function setTypes($types)
    {
        ...
        if (!is_null($types) && (count($types) > 4)) {
            throw new \InvalidArgumentException('invalid value for $types when calling CampaignAssetServiceSelector., number of items must be less than or equal to 4.');
        }
     ...
     * Gets user_statuses
     *
     * @return \OpenAPI\Client\Model\CampaignAssetServiceUserStatus[]|null
     */
     ...
     * Sets user_statuses
     *
     * @param \OpenAPI\Client\Model\CampaignAssetServiceUserStatus[]|null $user_statuses user_statuses
     *
     * @return self
     */
    public function setUserStatuses($user_statuses)
    {
        ...
        if (!is_null($user_statuses) && (count($user_statuses) > 2)) {
            throw new \InvalidArgumentException('invalid value for $user_statuses when calling CampaignAssetServiceSelector., number of items must be less than or equal to 2.');
        }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 500)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling CampaignAssetServiceSelector., must be smaller than or equal to 500.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling CampaignAssetServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling CampaignAssetServiceSelector., must be bigger than or equal to 1.');
        }
