...
class CampaignTargetServiceNetworkTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'network_coverage_type' => '\OpenAPI\Client\Model\CampaignTargetServiceNetworkCoverageType'
    ];
    ...
    {
        $this->setIfExists('network_coverage_type', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\CampaignTargetServiceNetworkCoverageType|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CampaignTargetServiceNetworkCoverageType|null $network_coverage_type network_coverage_type
     *
     * @return self
     */
    public function setNetworkCoverageType($network_coverage_type)
    {
        ...
        if (is_null($network_coverage_type)) {
            array_push($this->openAPINullablesSetToNull, 'network_coverage_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('network_coverage_type', $nullablesSetToNull);
            if ($index !== FALSE) {
