 ...
 */
class CampaignFeed implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets feed_item_id
     *
     * @param int|null $feed_item_id <div lang=\"ja\">FeedItem情報のIDです。<br> SET時、このフィールドは必須です。</div> <div lang=\"en\">FeedItem information ID.<br> This field is required in SET operation.</div>
     *
     * @return self
     */
