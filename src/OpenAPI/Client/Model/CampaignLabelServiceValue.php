...
class CampaignLabelServiceValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('campaign_label', $data ?? [], null);
    ...
    */
    ...
    public function setCampaignLabel($campaign_label)
    {
        ...
        if (is_null($campaign_label)) {
            array_push($this->openAPINullablesSetToNull, 'campaign_label');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('campaign_label', $nullablesSetToNull);
            if ($index !== FALSE) {
