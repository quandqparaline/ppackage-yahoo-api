...
class BudgetOrderServiceValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('budget_order', $data ?? [], null);
    ...
    */
    ...
    public function setBudgetOrder($budget_order)
    {
        ...
        if (is_null($budget_order)) {
            array_push($this->openAPINullablesSetToNull, 'budget_order');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('budget_order', $nullablesSetToNull);
            if ($index !== FALSE) {
