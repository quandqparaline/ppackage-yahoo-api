 ...
 */
class AdGroupFeed implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets ad_group_id
     *
     * @param int|null $ad_group_id <div lang=\"ja\">広告グループIDです。</div> <div lang=\"en\">Ad group ID.</div>
     *
     * @return self
     */
     ...
     * Sets feed_item_id
     *
     * @param int|null $feed_item_id <div lang=\"ja\">FeedItem情報のIDです。<br> SET時、このフィールドは必須となります。</div> <div lang=\"en\">FeedItem information ID.<br> This field is required in SET operation.</div>
     *
     * @return self
     */
