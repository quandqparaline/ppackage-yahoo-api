 ...
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;AccountServiceSelectorオブジェクトは、選択するアカウントを表します。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;AccountServiceSelector object explains which accounts to return.&lt;/div&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class AccountServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('include_manager_account', $data ?? [], null);
    ...
    */
     ...
     * Sets account_ids
     *
     * @param int[]|null $account_ids <div lang=\"ja\">アカウントIDの配列です。</div> <div lang=\"en\">Account IDs.</div>
     *
     * @return self
     */
    public function setAccountIds($account_ids)
    {
        ...
        if (!is_null($account_ids) && (count($account_ids) > 200)) {
            throw new \InvalidArgumentException('invalid value for $account_ids when calling AccountServiceSelector., number of items must be less than or equal to 200.');
        }
    ...
    public function setIncludeManagerAccount($include_manager_account)
    {
        ...
        if (is_null($include_manager_account)) {
            array_push($this->openAPINullablesSetToNull, 'include_manager_account');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('include_manager_account', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 200)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AccountServiceSelector., must be smaller than or equal to 200.');
        }
