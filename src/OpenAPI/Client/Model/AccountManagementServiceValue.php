...
class AccountManagementServiceValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('account_management', $data ?? [], null);
    ...
    */
    ...
    public function setAccountManagement($account_management)
    {
        ...
        if (is_null($account_management)) {
            array_push($this->openAPINullablesSetToNull, 'account_management');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('account_management', $nullablesSetToNull);
            if ($index !== FALSE) {
