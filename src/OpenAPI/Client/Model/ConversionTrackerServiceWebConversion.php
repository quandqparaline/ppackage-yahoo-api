...
class ConversionTrackerServiceWebConversion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'markup_language' => '\OpenAPI\Client\Model\ConversionTrackerServiceMarkupLanguage',
        'advanced_snippet' => 'string',
        'tracking_code_type' => '\OpenAPI\Client\Model\ConversionTrackerServiceTrackingCodeType'
    ];
    ...
    {
        $this->setIfExists('markup_language', $data ?? [], null);
        $this->setIfExists('advanced_snippet', $data ?? [], null);
        $this->setIfExists('tracking_code_type', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\ConversionTrackerServiceMarkupLanguage|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ConversionTrackerServiceMarkupLanguage|null $markup_language markup_language
     *
     * @return self
     */
    public function setMarkupLanguage($markup_language)
    {
        ...
        if (is_null($markup_language)) {
            array_push($this->openAPINullablesSetToNull, 'markup_language');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('markup_language', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param \OpenAPI\Client\Model\ConversionTrackerServiceTrackingCodeType|null $tracking_code_type tracking_code_type
     *
     * @return self
     */
    public function setTrackingCodeType($tracking_code_type)
    {
        ...
        if (is_null($tracking_code_type)) {
            array_push($this->openAPINullablesSetToNull, 'tracking_code_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tracking_code_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
