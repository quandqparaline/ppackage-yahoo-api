 ...
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;BiddingStrategyオブジェクトは、入札戦略を表します。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;Bidding strategy object displays the type of bid strategy.&lt;/div&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BiddingStrategy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'account_id' => 'int',
        'bidding_scheme' => '\OpenAPI\Client\Model\BiddingStrategyServiceBiddingScheme',
    ...
    */
     ...
     * Sets account_id
     *
     * @param int|null $account_id <div lang=\"ja\">アカウントIDです。<br> このフィールドは、いずれの場合でも必須です。</div> <div lang=\"en\">Account ID.<br> This field is required in any cases.</div>
     *
     * @return self
     */
     ...
     * Gets bidding_scheme
     *
     * @return \OpenAPI\Client\Model\BiddingStrategyServiceBiddingScheme|null
     */
     ...
     * Sets bidding_scheme
     *
     * @param \OpenAPI\Client\Model\BiddingStrategyServiceBiddingScheme|null $bidding_scheme bidding_scheme
     *
     * @return self
     */
     ...
     *
     * @param int|null $portfolio_bidding_id <div lang=\"ja\">ポートフォリオ入札IDです。<br> SET時およびREMOVE時、このフィールドは必須となります。</div> <div lang=\"en\">Portfolio bidding ID.<br> This field is optional in SET and REMOVE operation.</div>
     *
     * @return self
     */
     ...
     *
     * @param string|null $portfolio_bidding_name <div lang=\"ja\">ポートフォリオ入札名です（50文字以内になります）。<br> このフィールドは、ADD時は必須となり、SET時は省略可能となります。</div> <div lang=\"en\">Portfolio bidding name(Can set up to 50 characters).<br> This field is required in ADD operation, and will be optional in SET operation.</div>
     *
     * @return self
     */
