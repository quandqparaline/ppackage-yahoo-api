 ...
 */
class AdGroupRetargetingListServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('target_list_ids', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets account_id
     *
     * @param int $account_id <div lang=\"ja\">検索条件：アカウントIDです。</div> <div lang=\"en\">Account ID.</div>
     *
     * @return self
     */
     ...
     * Sets ad_group_ids
     *
     * @param int[]|null $ad_group_ids <div lang=\"ja\">検索条件：広告グループIDです。</div> <div lang=\"en\">Ad group ID.</div>
     *
     * @return self
     */
    public function setAdGroupIds($ad_group_ids)
    {
        ...
        if (!is_null($ad_group_ids) && (count($ad_group_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $ad_group_ids when calling AdGroupRetargetingListServiceSelector., number of items must be less than or equal to 1000.');
        }
     ...
     * Sets campaign_ids
     *
     * @param int[]|null $campaign_ids <div lang=\"ja\">検索条件：キャンペーンIDです。</div> <div lang=\"en\">Campaign ID.</div>
     *
     * @return self
     */
    public function setCampaignIds($campaign_ids)
    {
        ...
        if (!is_null($campaign_ids) && (count($campaign_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $campaign_ids when calling AdGroupRetargetingListServiceSelector., number of items must be less than or equal to 1000.');
        }
     ...
     *
     * @param int[]|null $target_list_ids <div lang=\"ja\">検索条件：ターゲットリストIDです。</div> <div lang=\"en\">Target list ID.</div>
     *
     * @return self
     */
    public function setTargetListIds($target_list_ids)
    {
        ...
        if (!is_null($target_list_ids) && (count($target_list_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $target_list_ids when calling AdGroupRetargetingListServiceSelector., number of items must be less than or equal to 1000.');
        }

        if (is_null($target_list_ids)) {
            array_push($this->openAPINullablesSetToNull, 'target_list_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('target_list_ids', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
