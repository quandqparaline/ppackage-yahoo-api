<?php
/**
 * DictionaryServiceAppLinkVendorSelector
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * DictionaryServiceAppLinkVendorSelector Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;DictionaryServiceAppLinkVendorSelectorオブジェクトは、 アプリ計測ベンダー情報一覧取得のリクエストを格納するコンテナです。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;DictionaryServiceAppLinkVendorSelectorobject is a containter that stores the request to get the App measurement vendor information list.&lt;/div&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DictionaryServiceAppLinkVendorSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DictionaryServiceAppLinkVendorSelector';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('number_results', $data ?? [], null);
    }
    ...
    */
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling DictionaryServiceAppLinkVendorSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling DictionaryServiceAppLinkVendorSelector., must be bigger than or equal to 1.');
        }
