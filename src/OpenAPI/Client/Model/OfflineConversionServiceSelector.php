 ...
 */
class OfflineConversionServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'account_id' => 'int',
        'upload_ids' => 'int[]',
        'sorts' => '\OpenAPI\Client\Model\OfflineConversionServiceSort[]',
        'number_results' => 'int',
        'start_index' => 'int'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['upload_ids']) && (count($this->container['upload_ids']) > 1000)) {
            $invalidProperties[] = "invalid value for 'upload_ids', number of items must be less than or equal to 1000.";
        }
     ...
     * Sets account_id
     *
     * @param int $account_id <div lang=\"ja\">検索条件：アカウントIDです。</div> <div lang=\"en\">Search conditon: Account ID.</div>
     *
     * @return self
     */
     ...
     * Sets upload_ids
     *
     * @param int[]|null $upload_ids <div lang=\"ja\">検索条件：アップロードIDです。</div> <div lang=\"en\">Search conditon: Upload ID.</div>
     *
     * @return self
     */
    public function setUploadIds($upload_ids)
    {
        ...
        if (!is_null($upload_ids) && (count($upload_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $upload_ids when calling OfflineConversionServiceSelector., number of items must be less than or equal to 1000.');
        }
     ...
     * Gets sorts
     *
     * @return \OpenAPI\Client\Model\OfflineConversionServiceSort[]|null
     */
     ...
     * Sets sorts
     *
     * @param \OpenAPI\Client\Model\OfflineConversionServiceSort[]|null $sorts sorts
     *
     * @return self
     */
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 1000)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling OfflineConversionServiceSelector., must be smaller than or equal to 1000.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling OfflineConversionServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling OfflineConversionServiceSelector., must be bigger than or equal to 1.');
        }
