...
/**
 * PageFeedAssetServiceReviewSummary Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;PageFeedAssetServiceReviewSummaryオブジェクトは、ページフィードアセットの審査成績、状況サマリーを格納します。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;PageFeedAssetServiceReviewSummary object retains the examination results of the page feed asset, the situation summary acquisition result.&lt;/div&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PageFeedAssetServiceReviewSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageFeedAssetServiceReviewSummary';
    ...
    */
     ...
     * Sets entity_count
     *
     * @param int|null $entity_count <div lang=\"ja\">ページフィードアセットセット内にあるページフィードアセットの総件数</div> <div lang=\"en\">Total count of page feed asset in page feed asset set.</div>
     *
     * @return self
     */
