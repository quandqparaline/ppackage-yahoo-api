...
class KeywordPlanIdeaServiceKeywordSeed implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KeywordPlanIdeaServiceKeywordSeed';
