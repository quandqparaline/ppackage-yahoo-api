...
class ConversionTrackerServiceValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('conversion_tracker', $data ?? [], null);
    ...
    */
    ...
    public function setConversionTracker($conversion_tracker)
    {
        ...
        if (is_null($conversion_tracker)) {
            array_push($this->openAPINullablesSetToNull, 'conversion_tracker');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('conversion_tracker', $nullablesSetToNull);
            if ($index !== FALSE) {
