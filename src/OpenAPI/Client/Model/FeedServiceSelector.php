...
class FeedServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'feed_ids' => 'int[]',
        'number_results' => 'int',
        'placeholder_types' => '\OpenAPI\Client\Model\FeedServicePlaceholderType[]',
        'start_index' => 'int'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('number_results', $data ?? [], 50);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['number_results']) && ($this->container['number_results'] > 50)) {
            $invalidProperties[] = "invalid value for 'number_results', must be smaller than or equal to 50.";
        }
        ...
        if (!is_null($this->container['placeholder_types']) && (count($this->container['placeholder_types']) > 2)) {
            $invalidProperties[] = "invalid value for 'placeholder_types', number of items must be less than or equal to 2.";
        }
     ...
     * Sets feed_ids
     *
     * @param int[]|null $feed_ids <div lang=\"ja\">自動データ挿入のリストのIDです。</div> <div lang=\"en\">List ID of Feed.</div>
     *
     * @return self
     */
    public function setFeedIds($feed_ids)
    {
        ...
        if (!is_null($feed_ids) && (count($feed_ids) > 200)) {
            throw new \InvalidArgumentException('invalid value for $feed_ids when calling FeedServiceSelector., number of items must be less than or equal to 200.');
        }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 50)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling FeedServiceSelector., must be smaller than or equal to 50.');
        }
     ...
     *
     * @param \OpenAPI\Client\Model\FeedServicePlaceholderType[]|null $placeholder_types placeholder_types
     *
     * @return self
     */
    public function setPlaceholderTypes($placeholder_types)
    {
        ...
        if (!is_null($placeholder_types) && (count($placeholder_types) > 2)) {
            throw new \InvalidArgumentException('invalid value for $placeholder_types when calling FeedServiceSelector., number of items must be less than or equal to 2.');
        }
