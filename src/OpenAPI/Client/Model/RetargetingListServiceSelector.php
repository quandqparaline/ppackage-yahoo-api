...
class RetargetingListServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('target_list_types', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['target_list_types']) && (count($this->container['target_list_types']) > 3)) {
            $invalidProperties[] = "invalid value for 'target_list_types', number of items must be less than or equal to 3.";
        }
     ...
     *
     * @param int[]|null $target_list_ids <div lang=\"ja\">検索条件：ターゲットリストIDです。</div> <div lang=\"en\">Search conditon: Target List ID.</div>
     *
     * @return self
     */
    ...
    public function setTargetListTypes($target_list_types)
    {
        ...
        if (!is_null($target_list_types) && (count($target_list_types) > 3)) {
            throw new \InvalidArgumentException('invalid value for $target_list_types when calling RetargetingListServiceSelector., number of items must be less than or equal to 3.');
        }

        if (is_null($target_list_types)) {
            array_push($this->openAPINullablesSetToNull, 'target_list_types');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('target_list_types', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
