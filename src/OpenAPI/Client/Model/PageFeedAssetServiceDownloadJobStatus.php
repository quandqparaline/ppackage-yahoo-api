<?php
/**
 * PageFeedAssetServiceDownloadJobStatus
 *
 * PHP version 7.4
 *
 * @category Class
...
class PageFeedAssetServiceDownloadJobStatus
{
    ...
    public const FIELDS_ERROR = 'FIELDS_ERROR';
