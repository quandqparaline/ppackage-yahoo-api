 ...
 */
class CampaignCriterionServiceValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'campaign_criterion' => '\OpenAPI\Client\Model\CampaignCriterion',
    ...
    {
        $this->setIfExists('campaign_criterion', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\CampaignCriterion|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CampaignCriterion|null $campaign_criterion campaign_criterion
     *
     * @return self
     */
    public function setCampaignCriterion($campaign_criterion)
    {
        ...
        if (is_null($campaign_criterion)) {
            array_push($this->openAPINullablesSetToNull, 'campaign_criterion');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('campaign_criterion', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param bool|null $operation_succeeded <div lang=\"ja\">処理結果です。</div> <div lang=\"en\">The operation.</div>
     *
     * @return self
     */
