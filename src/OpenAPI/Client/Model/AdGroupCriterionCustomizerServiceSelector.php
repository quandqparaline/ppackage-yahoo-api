...
/**
 * AdGroupCriterionCustomizerServiceSelector Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;AdGroupCriterionCustomizerServiceSelectorオブジェクトは、カスタマイザー属性の情報を指定します。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;AdGroupCriterionCustomizerServiceSelector describes the AdGroupCriterionCustomizer information.&lt;/div&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AdGroupCriterionCustomizerServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdGroupCriterionCustomizerServiceSelector';
    ...
    protected static $openAPITypes = [
        ...
        'ad_group_ids' => 'int[]',
        'criterion_ids' => 'int[]',
        'types' => '\OpenAPI\Client\Model\AdGroupCriterionCustomizerServiceType[]',
        'number_results' => 'int',
        'start_index' => 'int'
    ];
    ...
    */
     ...
     * Sets criterion_ids
     *
     * @param int[]|null $criterion_ids <div lang=\"ja\">検索条件：クライテリアID</div> <div lang=\"en\">Search condition: Criterion ID</div>
     *
     * @return self
     */
     ...
     * Gets types
     *
     * @return \OpenAPI\Client\Model\AdGroupCriterionCustomizerServiceType[]|null
     */
     ...
     * Sets types
     *
     * @param \OpenAPI\Client\Model\AdGroupCriterionCustomizerServiceType[]|null $types types
     *
     * @return self
     */
    public function setTypes($types)
    {
        ...
        if (!is_null($types) && (count($types) > 4)) {
            throw new \InvalidArgumentException('invalid value for $types when calling AdGroupCriterionCustomizerServiceSelector., number of items must be less than or equal to 4.');
        }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 2000)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AdGroupCriterionCustomizerServiceSelector., must be smaller than or equal to 2000.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AdGroupCriterionCustomizerServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling AdGroupCriterionCustomizerServiceSelector., must be bigger than or equal to 1.');
        }
