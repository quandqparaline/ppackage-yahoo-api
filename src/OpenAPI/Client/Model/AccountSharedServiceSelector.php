 ...
 */
class AccountSharedServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('number_results', $data ?? [], 20);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['number_results']) && ($this->container['number_results'] > 20)) {
            $invalidProperties[] = "invalid value for 'number_results', must be smaller than or equal to 20.";
        }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 20)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AccountSharedServiceSelector., must be smaller than or equal to 20.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AccountSharedServiceSelector., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param int[]|null $shared_list_ids <div lang=\"ja\">検索対象外キーワードリストIDです。</div> <div lang=\"en\">Negative keyword list ID.</div>
     *
     * @return self
     */
    public function setSharedListIds($shared_list_ids)
    {
        ...
        if (!is_null($shared_list_ids) && (count($shared_list_ids) > 20)) {
            throw new \InvalidArgumentException('invalid value for $shared_list_ids when calling AccountSharedServiceSelector., number of items must be less than or equal to 20.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling AccountSharedServiceSelector., must be bigger than or equal to 1.');
        }
