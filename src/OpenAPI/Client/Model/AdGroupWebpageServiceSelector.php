 ...
 */
class AdGroupWebpageServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['target_ids']) && (count($this->container['target_ids']) > 1000)) {
            $invalidProperties[] = "invalid value for 'target_ids', number of items must be less than or equal to 1000.";
        }
     ...
     * Sets ad_group_ids
     *
     * @param int[]|null $ad_group_ids <div lang=\"ja\">広告グループID</div> <div lang=\"en\">AdGroup ID</div>
     *
     * @return self
     */
    public function setAdGroupIds($ad_group_ids)
    {
        ...
        if (!is_null($ad_group_ids) && (count($ad_group_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $ad_group_ids when calling AdGroupWebpageServiceSelector., number of items must be less than or equal to 1000.');
        }
     ...
     * Sets campaign_ids
     *
     * @param int[]|null $campaign_ids <div lang=\"ja\">キャンペーンID</div> <div lang=\"en\">Campaign ID</div>
     *
     * @return self
     */
    public function setCampaignIds($campaign_ids)
    {
        ...
        if (!is_null($campaign_ids) && (count($campaign_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $campaign_ids when calling AdGroupWebpageServiceSelector., number of items must be less than or equal to 1000.');
        }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 2000)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AdGroupWebpageServiceSelector., must be smaller than or equal to 2000.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AdGroupWebpageServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling AdGroupWebpageServiceSelector., must be bigger than or equal to 1.');
        }
     ...
     * Sets target_ids
     *
     * @param int[]|null $target_ids <div lang=\"ja\">配信/除外設定を識別するID</div> <div lang=\"en\">Unique ID to identify &#39;Allow&#39; or &#39;Exclude&#39; settings</div>
     *
     * @return self
     */
    public function setTargetIds($target_ids)
    {
        ...
        if (!is_null($target_ids) && (count($target_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $target_ids when calling AdGroupWebpageServiceSelector., number of items must be less than or equal to 1000.');
        }
