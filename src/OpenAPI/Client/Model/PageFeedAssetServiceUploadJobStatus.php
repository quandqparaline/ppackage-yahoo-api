<?php
/**
 * PageFeedAssetServiceUploadJobStatus
 *
 * PHP version 7.4
 *
 * @category Class
...
class PageFeedAssetServiceUploadJobStatus
{
    ...
    public const INVALID_PAGE_FEED_ASSET_SET_ID = 'INVALID_PAGE_FEED_ASSET_SET_ID';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::INVALID_PAGE_FEED_ASSET_SET_ID,
            self::TIMEOUT,
            self::SYSTEM_ERROR,
            self::UNKNOWN
        ];
