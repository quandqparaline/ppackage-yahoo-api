...
/**
 * PageFeedAssetServiceGetJobStatusSelector Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;PageFeedAssetServiceGetJobStatusSelectorオブジェクトは、upload、downloadの処理状況を取得するための検索条件を格納します。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;PageFeedAssetServiceGetJobStatusSelector object retains search condition for The processing situation upload/download.&lt;/div&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PageFeedAssetServiceGetJobStatusSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageFeedAssetServiceGetJobStatusSelector';
    ...
    protected static $openAPITypes = [
        'account_id' => 'int',
        'job_ids' => 'int[]',
        'job_type' => '\OpenAPI\Client\Model\PageFeedAssetServiceGetJobStatusType',
        'number_results' => 'int',
        'start_index' => 'int'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['job_ids']) && (count($this->container['job_ids']) > 1000)) {
            $invalidProperties[] = "invalid value for 'job_ids', number of items must be less than or equal to 1000.";
        }
     ...
     * Sets job_ids
     *
     * @param int[]|null $job_ids <div lang=\"ja\">登録したジョブのID</div> <div lang=\"en\">Registered job ID</div>
     *
     * @return self
     */
    public function setJobIds($job_ids)
    {
        ...
        if (!is_null($job_ids) && (count($job_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $job_ids when calling PageFeedAssetServiceGetJobStatusSelector., number of items must be less than or equal to 1000.');
        }
     ...
     * Gets job_type
     *
     * @return \OpenAPI\Client\Model\PageFeedAssetServiceGetJobStatusType
     */
     ...
     * Sets job_type
     *
     * @param \OpenAPI\Client\Model\PageFeedAssetServiceGetJobStatusType $job_type job_type
     *
     * @return self
     */
    public function setJobType($job_type)
    {
        ...
        if (is_null($job_type)) {
            array_push($this->openAPINullablesSetToNull, 'job_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('job_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 10000)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling PageFeedAssetServiceGetJobStatusSelector., must be smaller than or equal to 10000.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling PageFeedAssetServiceGetJobStatusSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling PageFeedAssetServiceGetJobStatusSelector., must be bigger than or equal to 1.');
        }
