 ...
 */
class AdGroupFeedServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'feed_item_ids' => 'int[]',
        'number_results' => 'int',
        'placeholder_types' => '\OpenAPI\Client\Model\AdGroupFeedServicePlaceholderType[]',
        'start_index' => 'int'
    ];
    ...
    */
    ...
    public function setAdGroupIds($ad_group_ids)
    {
        ...
        if (!is_null($ad_group_ids) && (count($ad_group_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $ad_group_ids when calling AdGroupFeedServiceSelector., number of items must be less than or equal to 500.');
        }
    ...
    public function setCampaignIds($campaign_ids)
    {
        ...
        if (!is_null($campaign_ids) && (count($campaign_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $campaign_ids when calling AdGroupFeedServiceSelector., number of items must be less than or equal to 500.');
        }
    ...
    public function setFeedItemIds($feed_item_ids)
    {
        ...
        if (!is_null($feed_item_ids) && (count($feed_item_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $feed_item_ids when calling AdGroupFeedServiceSelector., number of items must be less than or equal to 500.');
        }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 500)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AdGroupFeedServiceSelector., must be smaller than or equal to 500.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AdGroupFeedServiceSelector., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\AdGroupFeedServicePlaceholderType[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AdGroupFeedServicePlaceholderType[]|null $placeholder_types placeholder_types
     *
     * @return self
     */
    public function setPlaceholderTypes($placeholder_types)
    {
        ...
        if (!is_null($placeholder_types) && (count($placeholder_types) > 4)) {
            throw new \InvalidArgumentException('invalid value for $placeholder_types when calling AdGroupFeedServiceSelector., number of items must be less than or equal to 4.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling AdGroupFeedServiceSelector., must be bigger than or equal to 1.');
        }
