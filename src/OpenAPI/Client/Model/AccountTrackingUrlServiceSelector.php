 ...
 */
class AccountTrackingUrlServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets account_ids
     *
     * @param int[]|null $account_ids <div lang=\"ja\">検索条件：アカウントIDです。</div> <div lang=\"en\">Search condition: Account ID.</div>
     *
     * @return self
     */
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 1000)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AccountTrackingUrlServiceSelector., must be smaller than or equal to 1000.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AccountTrackingUrlServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling AccountTrackingUrlServiceSelector., must be bigger than or equal to 1.');
        }
