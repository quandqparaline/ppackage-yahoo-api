...
/**
 * AppLinkServiceSelector Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;AppLinkServiceSelectorオブジェクトは、操作の対象となるコンバージョントラッカーおよびフィルタ条件を指定します。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;AppLinkServiceSelector object displays information and filter criteria of conversionTracker to be operated.&lt;/div&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AppLinkServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppLinkServiceSelector';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('app_link_ids', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['app_link_ids']) && (count($this->container['app_link_ids']) > 1000)) {
            $invalidProperties[] = "invalid value for 'app_link_ids', number of items must be less than or equal to 1000.";
        }
     ...
     * @return int[]|null
     */
    public function getAppLinkIds()
    {
        return $this->container['app_link_ids'];
    }

    /**
     * Sets app_link_ids
     *
     * @param int[]|null $app_link_ids <div lang=\"ja\">検索条件：アプリリンクIDです。<br> ※指定しない場合は、フィルタ条件に すべてのアプリリンク情報が含まれます。</div> <div lang=\"en\">Search condition: App Link ID<br> * All AppLink information will return, if no id are not specified.</div>
     *
     * @return self
     */
    public function setAppLinkIds($app_link_ids)
    {

        if (!is_null($app_link_ids) && (count($app_link_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $app_link_ids when calling AppLinkServiceSelector., number of items must be less than or equal to 1000.');
        }

        if (is_null($app_link_ids)) {
            array_push($this->openAPINullablesSetToNull, 'app_link_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('app_link_ids', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['app_link_ids'] = $app_link_ids;
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 500)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AppLinkServiceSelector., must be smaller than or equal to 500.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AppLinkServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling AppLinkServiceSelector., must be bigger than or equal to 1.');
        }
