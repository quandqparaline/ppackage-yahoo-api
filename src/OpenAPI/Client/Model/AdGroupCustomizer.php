...
/**
 * AdGroupCustomizer Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;AdGroupCustomizerオブジェクトは、広告グループとカスタマイザー属性間の設定情報を格納します。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;AdGroupCustomizer object contains the configuration information between the adgroup and the customizer attribute.&lt;/div&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AdGroupCustomizer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdGroupCustomizer';
    ...
    protected static $openAPITypes = [
        ...
        'value' => 'string',
        'approval_status' => '\OpenAPI\Client\Model\AdGroupCustomizerServiceApprovalStatus',
    ...
    */
     ...
     * Sets ad_group_id
     *
     * @param int|null $ad_group_id <div lang=\"ja\">広告グループIDです。<br> ADDおよびREMOVE時、このフィールドは必須となります。</div> <div lang=\"en\">AdGroup ID.<br> This field is required in ADD and REMOVE operation.</div>
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AdGroupCustomizerServiceApprovalStatus|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AdGroupCustomizerServiceApprovalStatus|null $approval_status approval_status
     *
     * @return self
     */
