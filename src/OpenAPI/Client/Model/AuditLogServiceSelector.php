...
class AuditLogServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets job_ids
     *
     * @param int[]|null $job_ids <div lang=\"ja\">登録したジョブのIDです。</div> <div lang=\"en\">Created job ID</div>
     *
     * @return self
     */
    public function setJobIds($job_ids)
    {
        ...
        if (!is_null($job_ids) && (count($job_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $job_ids when calling AuditLogServiceSelector., number of items must be less than or equal to 1000.');
        }
     ...
     * Sets job_statuses
     *
     * @param \OpenAPI\Client\Model\AuditLogServiceJobStatus[]|null $job_statuses job_statuses
     *
     * @return self
     */
    public function setJobStatuses($job_statuses)
    {
        ...
        if (!is_null($job_statuses) && (count($job_statuses) > 4)) {
            throw new \InvalidArgumentException('invalid value for $job_statuses when calling AuditLogServiceSelector., number of items must be less than or equal to 4.');
        }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 1000)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AuditLogServiceSelector., must be smaller than or equal to 1000.');
        }
