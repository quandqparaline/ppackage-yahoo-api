...
class RetargetingListServiceOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'account_id' => 'int',
        'operand' => '\OpenAPI\Client\Model\RetargetingListServiceTargetingList[]',
    ...
    */
     ...
     * Gets operand
     *
     * @return \OpenAPI\Client\Model\RetargetingListServiceTargetingList[]
     */
     ...
     * Sets operand
     *
     * @param \OpenAPI\Client\Model\RetargetingListServiceTargetingList[] $operand operand
     *
     * @return self
     */
    public function setOperand($operand)
    {
        ...
        if ((count($operand) > 200)) {
            throw new \InvalidArgumentException('invalid value for $operand when calling RetargetingListServiceOperation., number of items must be less than or equal to 200.');
        }
        if ((count($operand) < 1)) {
