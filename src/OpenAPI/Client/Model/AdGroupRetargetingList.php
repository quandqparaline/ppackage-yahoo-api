 ...
 */
class AdGroupRetargetingList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'criterion_target_list' => '\OpenAPI\Client\Model\AdGroupRetargetingListServiceCriterionTargetList',
        'excluded_type' => '\OpenAPI\Client\Model\AdGroupRetargetingListServiceExcludedType'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('criterion_target_list', $data ?? [], null);
    ...
    */
     ...
     * Sets bid_multiplier
     *
     * @param float|null $bid_multiplier <div lang=\"ja\">   CPC上昇値です。<br>   0.10～10.00まで指定できます。<br>   また、0を指定した場合、広告は配信されません。<br>   CPC上昇値の値は小数点第二位まで指定可能です。<br>   このフィールドは省略可能となります。その際、デフォルト設定値は1.0となります。 </div> <div lang=\"en\">   Maximum CPC increase value.<br>   Can be specified between  0.10 to 10.00.<br>   When specified &#39;0&#39;, the ad will not be delivered.<br>   Maximum CPC increase value can be specified up to two decimal places.<br>   This field is optional. The default value will be 1.0. </div>
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AdGroupRetargetingListServiceCriterionTargetList|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AdGroupRetargetingListServiceCriterionTargetList|null $criterion_target_list criterion_target_list
     *
     * @return self
     */
    public function setCriterionTargetList($criterion_target_list)
    {
        ...
        if (is_null($criterion_target_list)) {
            array_push($this->openAPINullablesSetToNull, 'criterion_target_list');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('criterion_target_list', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets excluded_type
     *
     * @return \OpenAPI\Client\Model\AdGroupRetargetingListServiceExcludedType|null
     */
     ...
     * Sets excluded_type
     *
     * @param \OpenAPI\Client\Model\AdGroupRetargetingListServiceExcludedType|null $excluded_type excluded_type
     *
     * @return self
     */
