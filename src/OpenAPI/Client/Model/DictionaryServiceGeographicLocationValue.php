...
class DictionaryServiceGeographicLocationValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('geographic_location', $data ?? [], null);
    ...
    */
    ...
    public function setGeographicLocation($geographic_location)
    {
        ...
        if (is_null($geographic_location)) {
            array_push($this->openAPINullablesSetToNull, 'geographic_location');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('geographic_location', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param bool|null $operation_succeeded <div lang=\"ja\">オペレーション成功です。</div> <div lang=\"en\">Operation is successful.</div>
     *
     * @return self
     */
