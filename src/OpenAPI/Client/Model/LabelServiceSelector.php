...
class LabelServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'account_id' => 'int',
        'count_labeled_entity' => '\OpenAPI\Client\Model\LabelServiceCountLabeledEntity',
        'label_ids' => 'int[]',
        'number_results' => 'int',
        'start_index' => 'int'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('count_labeled_entity', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\LabelServiceCountLabeledEntity|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\LabelServiceCountLabeledEntity|null $count_labeled_entity count_labeled_entity
     *
     * @return self
     */
    public function setCountLabeledEntity($count_labeled_entity)
    {
        ...
        if (is_null($count_labeled_entity)) {
            array_push($this->openAPINullablesSetToNull, 'count_labeled_entity');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('count_labeled_entity', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets label_ids
     *
     * @param int[]|null $label_ids <div lang=\"ja\">ラベルID<br>指定しない場合は、フィルタ条件に すべてのラベルが含まれます。</div> <div lang=\"en\">Label ID.<br>If not specified, the filter condition includes all labels.</div>
     *
     * @return self
     */
    public function setLabelIds($label_ids)
    {
        ...
        if (!is_null($label_ids) && (count($label_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $label_ids when calling LabelServiceSelector., number of items must be less than or equal to 1000.');
        }
