...
/**
 * CampaignCustomizer Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;CampaignCustomizerオブジェクトは、キャンペーンとカスタマイザー属性間の設定情報を格納します。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;CampaignCustomizer object contains the configuration information between the campaign and the customizer attribute.&lt;/div&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CampaignCustomizer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignCustomizer';
    ...
    protected static $openAPITypes = [
        ...
        'value' => 'string',
        'approval_status' => '\OpenAPI\Client\Model\CampaignCustomizerServiceApprovalStatus',
    ...
    */
     ...
     * Sets campaign_id
     *
     * @param int|null $campaign_id <div lang=\"ja\">キャンペーンIDです。<br> ADDおよびREMOVE時、このフィールドは必須となります。</div> <div lang=\"en\">Campaign ID.<br> This field is required in ADD and REMOVE operation.</div>
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\CampaignCustomizerServiceApprovalStatus|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CampaignCustomizerServiceApprovalStatus|null $approval_status approval_status
     *
     * @return self
     */
