 ...
 */
class CampaignSharedSetServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets account_id
     *
     * @param int $account_id <div lang=\"ja\">検索条件：アカウントIDです。</div> <div lang=\"en\">Search criteria : Account ID.</div>
     *
     * @return self
     */
     ...
     * Sets campaign_ids
     *
     * @param int[]|null $campaign_ids <div lang=\"ja\">検索条件：キャンペーンIDです。</div> <div lang=\"en\">Search criteria : Campaign ID.</div>
     *
     * @return self
     */
    public function setCampaignIds($campaign_ids)
    {
        ...
        if (!is_null($campaign_ids) && (count($campaign_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $campaign_ids when calling CampaignSharedSetServiceSelector., number of items must be less than or equal to 1000.');
        }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 1000)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling CampaignSharedSetServiceSelector., must be smaller than or equal to 1000.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling CampaignSharedSetServiceSelector., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param int[]|null $shared_list_ids <div lang=\"ja\">検索条件：対象外キーワードリストIDです。</div> <div lang=\"en\">Search criteria : Shared list ID.</div>
     *
     * @return self
     */
    public function setSharedListIds($shared_list_ids)
    {
        ...
        if (!is_null($shared_list_ids) && (count($shared_list_ids) > 20)) {
            throw new \InvalidArgumentException('invalid value for $shared_list_ids when calling CampaignSharedSetServiceSelector., number of items must be less than or equal to 20.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling CampaignSharedSetServiceSelector., must be bigger than or equal to 1.');
        }
