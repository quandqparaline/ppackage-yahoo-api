...
class AuditLogServiceSourceType
{
    ...
    public const YAHOO_JAPAN = 'YAHOO_JAPAN';

    public const CAMPAIGN_MANAGEMENT_TOOL = 'CAMPAIGN_MANAGEMENT_TOOL';
