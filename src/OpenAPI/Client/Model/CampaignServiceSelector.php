...
class CampaignServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'campaign_ids' => 'int[]',
        'contains_label_id' => '\OpenAPI\Client\Model\CampaignServiceContainsLabelId',
        'label_ids' => 'int[]',
        'number_results' => 'int',
        'start_index' => 'int',
        ...
        'budget_amount_range' => '\OpenAPI\Client\Model\CampaignServiceBudgetAmountRange'
    ];
    ...
    protected static $setters = [
        ...
        'budget_amount_range' => 'setBudgetAmountRange'
    ];
    ...
    protected static $getters = [
        ...
        'budget_amount_range' => 'getBudgetAmountRange'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('budget_amount_range', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param int[]|null $portfolio_bidding_ids <div lang=\"ja\">検索条件：ポートフォリオ入札IDです。</div> <div lang=\"en\">Search condition: Portfolio bidding ID.</div>
     *
     * @return self
     */
    public function setPortfolioBiddingIds($portfolio_bidding_ids)
    {
        ...
        if (!is_null($portfolio_bidding_ids) && (count($portfolio_bidding_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $portfolio_bidding_ids when calling CampaignServiceSelector., number of items must be less than or equal to 1000.');
        }
     ...
     * Sets campaign_ids
     *
     * @param int[]|null $campaign_ids <div lang=\"ja\">検索条件：キャンペーンIDです。<br> ※指定しない場合は、フィルタ条件に すべてのキャンペーンが含まれます。</div> <div lang=\"en\">Search condition: Campaign ID<br> * All campaign will return, if no campaign are not specified.</div>
     *
     * @return self
     */
    public function setCampaignIds($campaign_ids)
    {
        ...
        if (!is_null($campaign_ids) && (count($campaign_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $campaign_ids when calling CampaignServiceSelector., number of items must be less than or equal to 1000.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\CampaignServiceContainsLabelId|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CampaignServiceContainsLabelId|null $contains_label_id contains_label_id
     *
     * @return self
     */
     ...
     * Sets label_ids
     *
     * @param int[]|null $label_ids <div lang=\"ja\">検索条件：ラベルIDです。</div> <div lang=\"en\">Search condition: Label ID.</div>
     *
     * @return self
     */
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 10000)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling CampaignServiceSelector., must be smaller than or equal to 10000.');
        }
     ...
     * Sets user_statuses
     *
     * @param \OpenAPI\Client\Model\CampaignServiceUserStatus[]|null $user_statuses user_statuses
     *
     * @return self
     */
    ...
    /**
     * Gets budget_amount_range
     *
     * @return \OpenAPI\Client\Model\CampaignServiceBudgetAmountRange|null
     */
    public function getBudgetAmountRange()
    {
        return $this->container['budget_amount_range'];
    }

    /**
     * Sets budget_amount_range
     *
     * @param \OpenAPI\Client\Model\CampaignServiceBudgetAmountRange|null $budget_amount_range budget_amount_range
     *
     * @return self
     */
    public function setBudgetAmountRange($budget_amount_range)
    {

        if (is_null($budget_amount_range)) {
            array_push($this->openAPINullablesSetToNull, 'budget_amount_range');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('budget_amount_range', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['budget_amount_range'] = $budget_amount_range;
