 ...
 */
class CampaignRetargetingListServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'account_id' => 'int',
        'campaign_ids' => 'int[]',
        'excluded_type' => '\OpenAPI\Client\Model\CampaignRetargetingListServiceExcludedType',
        'number_results' => 'int',
        'start_index' => 'int',
        'target_list_ids' => 'int[]'
    ];
    ...
    */
     ...
     * Sets account_id
     *
     * @param int $account_id <div lang=\"ja\">アカウントIDです。</div> <div lang=\"en\">Search conditon: Account ID.</div>
     *
     * @return self
     */
     ...
     * Sets campaign_ids
     *
     * @param int[]|null $campaign_ids <div lang=\"ja\">キャンペーンIDです。</div> <div lang=\"en\">Search conditon: Campaign ID.</div>
     *
     * @return self
     */
    public function setCampaignIds($campaign_ids)
    {
        ...
        if (!is_null($campaign_ids) && (count($campaign_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $campaign_ids when calling CampaignRetargetingListServiceSelector., number of items must be less than or equal to 1000.');
        }
     ...
     * Gets excluded_type
     *
     * @return \OpenAPI\Client\Model\CampaignRetargetingListServiceExcludedType|null
     */
     ...
     * Sets excluded_type
     *
     * @param \OpenAPI\Client\Model\CampaignRetargetingListServiceExcludedType|null $excluded_type excluded_type
     *
     * @return self
     */
     ...
     *
     * @param int[]|null $target_list_ids <div lang=\"ja\">ターゲットリストIDです。</div> <div lang=\"en\">Search conditon: Target List ID.</div>
     *
     * @return self
     */
    public function setTargetListIds($target_list_ids)
    {
        ...
        if (!is_null($target_list_ids) && (count($target_list_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $target_list_ids when calling CampaignRetargetingListServiceSelector., number of items must be less than or equal to 1000.');
        }
