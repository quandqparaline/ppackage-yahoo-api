...
/**
 * KeywordPlanIdeaServiceSelector Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;KeywordPlanIdeaSelectorオブジェクトは、関連キーワードの提案条件を表します。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;Condition for related keyword suggestion.&lt;/div&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class KeywordPlanIdeaServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KeywordPlanIdeaServiceSelector';
    ...
    protected static $openAPITypes = [
        'account_id' => 'int',
        'seed' => '\OpenAPI\Client\Model\KeywordPlanIdeaServiceSeed',
        'start_index' => 'int',
        'number_results' => 'int'
    ];
    ...
    */
     ...
     * Sets account_id
     *
     * @param int $account_id <div lang=\"ja\">アカウントIDです。<br> このフィールドは必須となります。</div> <div lang=\"en\">Account ID.<br> This field is required.</div>
     *
     * @return self
     */
     ...
     * Gets seed
     *
     * @return \OpenAPI\Client\Model\KeywordPlanIdeaServiceSeed
     */
     ...
     * Sets seed
     *
     * @param \OpenAPI\Client\Model\KeywordPlanIdeaServiceSeed $seed seed
     *
     * @return self
     */
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling KeywordPlanIdeaServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 500)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling KeywordPlanIdeaServiceSelector., must be smaller than or equal to 500.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling KeywordPlanIdeaServiceSelector., must be bigger than or equal to 1.');
        }
