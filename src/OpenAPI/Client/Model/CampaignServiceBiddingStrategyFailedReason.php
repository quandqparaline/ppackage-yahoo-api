...
class CampaignServiceBiddingStrategyFailedReason
{
    ...
    public const CANNOT_CREATE_CAMPAIGN_WITH_CONVERSION_OPTIMIZER = 'CANNOT_CREATE_CAMPAIGN_WITH_CONVERSION_OPTIMIZER';

    public const BIDDING_STRATEGY_CANNOT_BE_OVERRIDDEN = 'BIDDING_STRATEGY_CANNOT_BE_OVERRIDDEN';
