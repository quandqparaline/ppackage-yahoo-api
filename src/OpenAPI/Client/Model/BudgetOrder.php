...
class BudgetOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('limit_charge_type', $data ?? [], null);
    }
    ...
    */
    ...
    public function setLimitChargeType($limit_charge_type)
    {
        ...
        if (is_null($limit_charge_type)) {
            array_push($this->openAPINullablesSetToNull, 'limit_charge_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('limit_charge_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
