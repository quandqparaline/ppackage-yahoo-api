 ...
 */
class AdGroupBidMultiplierServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'campaign_ids' => 'int[]',
        'number_results' => 'int',
        'platform_types' => '\OpenAPI\Client\Model\AdGroupBidMultiplierServicePlatformType[]',
        'start_index' => 'int'
    ];
    ...
    */
    ...
    public function setAdGroupIds($ad_group_ids)
    {
        ...
        if (!is_null($ad_group_ids) && (count($ad_group_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $ad_group_ids when calling AdGroupBidMultiplierServiceSelector., number of items must be less than or equal to 1000.');
        }
    ...
    public function setCampaignIds($campaign_ids)
    {
        ...
        if (!is_null($campaign_ids) && (count($campaign_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $campaign_ids when calling AdGroupBidMultiplierServiceSelector., number of items must be less than or equal to 1000.');
        }
     ...
     * Sets platform_types
     *
     * @param \OpenAPI\Client\Model\AdGroupBidMultiplierServicePlatformType[]|null $platform_types platform_types
     *
     * @return self
     */
    public function setPlatformTypes($platform_types)
    {
        ...
        if (!is_null($platform_types) && (count($platform_types) > 3)) {
            throw new \InvalidArgumentException('invalid value for $platform_types when calling AdGroupBidMultiplierServiceSelector., number of items must be less than or equal to 3.');
        }
