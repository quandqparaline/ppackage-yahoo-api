 ...
 */
class PageFeedItemServiceReviewSummarySelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets feed_ids
     *
     * @param int[]|null $feed_ids <div lang=\"ja\">フィードID</div> <div lang=\"en\">Feed ID</div>
     *
     * @return self
     */
    public function setFeedIds($feed_ids)
    {
        ...
        if (!is_null($feed_ids) && (count($feed_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $feed_ids when calling PageFeedItemServiceReviewSummarySelector., number of items must be less than or equal to 1000.');
        }
