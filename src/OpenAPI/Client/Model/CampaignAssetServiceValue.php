...
/**
 * CampaignAssetServiceValue Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;CampaignAssetServiceValueオブジェクトは、キャンペーンとアセット間の設定情報を格納するコンテナです。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;CampaignAssetServiceValue is a container of configuration information between campaign and assets.&lt;/div&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CampaignAssetServiceValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignAssetServiceValue';
    ...
    protected static $openAPITypes = [
        'campaign_asset' => '\OpenAPI\Client\Model\CampaignAsset',
    ...
    protected static $setters = [
        'campaign_asset' => 'setCampaignAsset',
        'errors' => 'setErrors',
    ...
    protected static $getters = [
        'campaign_asset' => 'getCampaignAsset',
        'errors' => 'getErrors',
    ...
    {
        $this->setIfExists('campaign_asset', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['campaign_asset'];
    }

    /**
     * Sets campaign_asset
     *
     * @param \OpenAPI\Client\Model\CampaignAsset|null $campaign_asset campaign_asset
     *
     * @return self
     */
    public function setCampaignAsset($campaign_asset)
    {

        if (is_null($campaign_asset)) {
            array_push($this->openAPINullablesSetToNull, 'campaign_asset');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('campaign_asset', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['campaign_asset'] = $campaign_asset;
