...
class CampaignCriterion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'criterion' => '\OpenAPI\Client\Model\CampaignCriterionServiceCriterion',
    ...
    */
     ...
     * Sets account_id
     *
     * @param int|null $account_id <div lang=\"ja\">アカウントIDです。<br> ADD時およびREMOVE時、このフィールドは必須です。</div> <div lang=\"en\">Account ID.<br> This field is required in ADD and REMOVE operation.</div>
     *
     * @return self
     */
     ...
     * Gets criterion
     *
     * @return \OpenAPI\Client\Model\CampaignCriterionServiceCriterion|null
     */
     ...
     * Sets criterion
     *
     * @param \OpenAPI\Client\Model\CampaignCriterionServiceCriterion|null $criterion criterion
     *
     * @return self
     */
