...
/**
 * AdGroupAssetServiceSelector Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;AdGroupAssetServiceSelectorオブジェクトは、アセット情報を指定します。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;AdGroupAssetServiceSelector describes the Asset information.&lt;/div&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AdGroupAssetServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdGroupAssetServiceSelector';
    ...
    protected static $openAPITypes = [
        ...
        'campaign_ids' => 'int[]',
        'asset_ids' => 'int[]',
        'types' => '\OpenAPI\Client\Model\AdGroupAssetServiceType[]',
        'user_statuses' => '\OpenAPI\Client\Model\AdGroupAssetServiceUserStatus[]',
        'number_results' => 'int',
        'start_index' => 'int'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['asset_ids']) && (count($this->container['asset_ids']) > 500)) {
            $invalidProperties[] = "invalid value for 'asset_ids', number of items must be less than or equal to 500.";
        }
    ...
    public function setAdGroupIds($ad_group_ids)
    {
        ...
        if (!is_null($ad_group_ids) && (count($ad_group_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $ad_group_ids when calling AdGroupAssetServiceSelector., number of items must be less than or equal to 500.');
        }
    ...
    public function setCampaignIds($campaign_ids)
    {
        ...
        if (!is_null($campaign_ids) && (count($campaign_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $campaign_ids when calling AdGroupAssetServiceSelector., number of items must be less than or equal to 500.');
        }
     ...
     * Sets asset_ids
     *
     * @param int[]|null $asset_ids <div lang=\"ja\">アセット情報のIDです。</div> <div lang=\"en\">Asset information ID.</div>
     *
     * @return self
     */
    public function setAssetIds($asset_ids)
    {
        ...
        if (!is_null($asset_ids) && (count($asset_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $asset_ids when calling AdGroupAssetServiceSelector., number of items must be less than or equal to 500.');
        }

        if (is_null($asset_ids)) {
            array_push($this->openAPINullablesSetToNull, 'asset_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('asset_ids', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets types
     *
     * @param \OpenAPI\Client\Model\AdGroupAssetServiceType[]|null $types types
     *
     * @return self
     */
    public function setTypes($types)
    {
        ...
        if (!is_null($types) && (count($types) > 4)) {
            throw new \InvalidArgumentException('invalid value for $types when calling AdGroupAssetServiceSelector., number of items must be less than or equal to 4.');
        }
     ...
     * Sets user_statuses
     *
     * @param \OpenAPI\Client\Model\AdGroupAssetServiceUserStatus[]|null $user_statuses user_statuses
     *
     * @return self
     */
    public function setUserStatuses($user_statuses)
    {
        ...
        if (!is_null($user_statuses) && (count($user_statuses) > 2)) {
            throw new \InvalidArgumentException('invalid value for $user_statuses when calling AdGroupAssetServiceSelector., number of items must be less than or equal to 2.');
        }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 500)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AdGroupAssetServiceSelector., must be smaller than or equal to 500.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AdGroupAssetServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling AdGroupAssetServiceSelector., must be bigger than or equal to 1.');
        }
