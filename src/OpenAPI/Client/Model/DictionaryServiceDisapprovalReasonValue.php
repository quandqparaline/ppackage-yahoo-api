...
class DictionaryServiceDisapprovalReasonValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('disapproval_reason', $data ?? [], null);
    ...
    */
    ...
    public function setDisapprovalReason($disapproval_reason)
    {
        ...
        if (is_null($disapproval_reason)) {
            array_push($this->openAPINullablesSetToNull, 'disapproval_reason');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('disapproval_reason', $nullablesSetToNull);
            if ($index !== FALSE) {
