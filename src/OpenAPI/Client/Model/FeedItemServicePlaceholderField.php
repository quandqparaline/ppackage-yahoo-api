...
class FeedItemServicePlaceholderField
{
    ...
    public const LINK_DESCRIPTION_1 = 'LINK_DESCRIPTION_1';

    public const LINK_DESCRIPTION_2 = 'LINK_DESCRIPTION_2';

    public const ADVANCED_URL = 'ADVANCED_URL';

    public const ADVANCED_MOBILE_URL = 'ADVANCED_MOBILE_URL';

    public const TRACKING_URL = 'TRACKING_URL';

    public const CALL_PHONE_NUMBER = 'CALL_PHONE_NUMBER';
    ...
    public const CALLOUT_TEXT = 'CALLOUT_TEXT';

    public const ADDITIONAL_ADVANCED_URLS = 'ADDITIONAL_ADVANCED_URLS';

    public const ADDITIONAL_ADVANCED_MOBILE_URLS = 'ADDITIONAL_ADVANCED_MOBILE_URLS';

    public const STRUCTURED_SNIPPET_HEADER = 'STRUCTURED_SNIPPET_HEADER';

    public const STRUCTURED_SNIPPET_VALUES = 'STRUCTURED_SNIPPET_VALUES';
