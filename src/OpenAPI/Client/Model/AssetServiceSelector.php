...
/**
 * AssetServiceSelector Class Doc Comment
 *
 * @category Class
 * @description &lt;div lang&#x3D;\&quot;ja\&quot;&gt;AssetServiceSelectorオブジェクトは、アセットの情報を指定します。&lt;/div&gt; &lt;div lang&#x3D;\&quot;en\&quot;&gt;AssetServiceSelector describes the Asset information.&lt;/div&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AssetServiceSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssetServiceSelector';
    ...
    protected static $openAPITypes = [
        'account_id' => 'int',
        'asset_ids' => 'int[]',
        'types' => '\OpenAPI\Client\Model\AssetServiceType[]',
        'approval_statuses' => '\OpenAPI\Client\Model\AssetServiceApprovalStatus[]',
        'number_results' => 'int',
        'start_index' => 'int'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['asset_ids']) && (count($this->container['asset_ids']) > 1000)) {
            $invalidProperties[] = "invalid value for 'asset_ids', number of items must be less than or equal to 1000.";
        }
     ...
     * Sets asset_ids
     *
     * @param int[]|null $asset_ids <div lang=\"ja\">検索条件：アセットIDです。</div> <div lang=\"en\">Search condition: Asset ID.</div>
     *
     * @return self
     */
    public function setAssetIds($asset_ids)
    {
        ...
        if (!is_null($asset_ids) && (count($asset_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $asset_ids when calling AssetServiceSelector., number of items must be less than or equal to 1000.');
        }
     ...
     * Sets types
     *
     * @param \OpenAPI\Client\Model\AssetServiceType[]|null $types types
     *
     * @return self
     */
    public function setTypes($types)
    {
        ...
        if (!is_null($types) && (count($types) > 4)) {
            throw new \InvalidArgumentException('invalid value for $types when calling AssetServiceSelector., number of items must be less than or equal to 4.');
        }
     ...
     *
     * @param \OpenAPI\Client\Model\AssetServiceApprovalStatus[]|null $approval_statuses approval_statuses
     *
     * @return self
     */
    public function setApprovalStatuses($approval_statuses)
    {
        ...
        if (!is_null($approval_statuses) && (count($approval_statuses) > 5)) {
            throw new \InvalidArgumentException('invalid value for $approval_statuses when calling AssetServiceSelector., number of items must be less than or equal to 5.');
        }
    ...
    public function setNumberResults($number_results)
    {
        ...
        if (!is_null($number_results) && ($number_results > 2000)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AssetServiceSelector., must be smaller than or equal to 2000.');
        }
        if (!is_null($number_results) && ($number_results < 1)) {
            throw new \InvalidArgumentException('invalid value for $number_results when calling AssetServiceSelector., must be bigger than or equal to 1.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (!is_null($start_index) && ($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling AssetServiceSelector., must be bigger than or equal to 1.');
        }
