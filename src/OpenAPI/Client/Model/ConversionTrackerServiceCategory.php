...
class ConversionTrackerServiceCategory
{
    ...
    public const SUBSCRIBE_PAID = 'SUBSCRIBE_PAID';

    public const PHONE_CALL_LEAD = 'PHONE_CALL_LEAD';

    public const SUBMIT_LEAD_FORM = 'SUBMIT_LEAD_FORM';

    public const BOOK_APPOINTMENT = 'BOOK_APPOINTMENT';

    public const REQUEST_QUOTE = 'REQUEST_QUOTE';

    public const GET_DIRECTIONS = 'GET_DIRECTIONS';
    ...
    public const STORE_VISIT = 'STORE_VISIT';

    public const STORE_SALE = 'STORE_SALE';

    public const QUALIFIED_LEAD = 'QUALIFIED_LEAD';

    public const CONVERTED_LEAD = 'CONVERTED_LEAD';
